...
RUN rm -rf /azure-functions-host/workers/python/3.6/LINUX/X64/azure_functions_worker && \
    rm -rf /azure-functions-host/workers/python/3.6/LINUX/X64/azure/functions

# Use the following command to run the docker image with customizible worker and library
VOLUME ["/azure-functions-host/workers/python/3.6/LINUX/X64/azure_functions_worker", "/azure-functions-host/workers/python/3.6/LINUX/X64/azure/functions"]
